                        ...
                        <div className="row d-flex justify-content-between align-items-center">
                          <div className="col-4">
                            <div className="row m-2">
                              <div className="d-flex justify-content-between text_Pool_total">
                                <h6>Total locked:</h6>
                                <p>Total locked:</p>
                              </div>
                              <div className="d-flex justify-content-between text_Pool_total">
                          ...
                          <div className="col-7 ">
                            <div className="row d-flex justify-content-between">
                              <div
                                className="col-5 farming_box  mt-3"
                                style={{ height: "100px" }}
                              >
                              ...
                              <div
                                className="col-5 farming_box mt-3 mb-3"
                                style={{ height: "100px" }}
                              >
                                <h5 className="m-2">Start Staking</h5>
                                <div className="d-grid gap-2 mb-3">
                                  <button
